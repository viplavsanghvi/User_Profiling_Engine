...
test=pd.read_csv('./test_files/items_buys_per_clicks_feature_mod.csv')
test['clicks']=pd.read_csv('./test_files/items_clicks_feature.csv')
# test['day-of-month']=pd.read_csv('./test_files/items_day_of_month_feature.csv')
# test['day-of-week']=pd.read_csv('./test_files/items_day_of_week_feature.csv')
# test['duration']=pd.read_csv('./test_files/items_duration_feature_int.csv')
test['day-hour']=pd.read_csv('./test_files/items_day_hour_mod_feature.csv')
test['month']=pd.read_csv('./test_files/items_month_feature.csv')
test['popular']=pd.read_csv('./test_files/items_popularity_feature.csv')
print(test.shape)
...
test_session_item=pd.read_csv('./test_session_item.csv')
